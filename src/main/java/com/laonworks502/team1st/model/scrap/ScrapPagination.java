...
public class ScrapPagination {
    ...
    public ScrapPagination(int startPage, int endPage) {
    }

    public ScrapPagination(int board_id, int postsTotal, int pagePostsCount) {
    ...
    public ScrapPagination(int board_id, int page, int postsTotal, int pagePostsCount) {
        this.board_id = board_id;
        this.page = page;
        this.postsTotal = postsTotal;
        this.pagePostsCount = pagePostsCount;
